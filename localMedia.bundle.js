...
function isScreenShareSourceAvailable() {
  return _isScreenShareSourceAvailable.apply(this, arguments);
}
function _isScreenShareSourceAvailable() {
  _isScreenShareSourceAvailable = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.t1 = navigator.getDisplayMedia;
          if (_context2.t1) {
            _context2.next = 5;
            break;
          }
        ...
        case 5:
          ...
          _context2.t0 = Boolean(navigator.mediaDevices.getSupportedConstraints().mediaSource);
        case 8:
...
var LocalMedia = function LocalMedia(opts) {
  var _this = this;
...
function getDisplayMedia(_x) {
  return _getDisplayMedia.apply(this, arguments);
}
function _getDisplayMedia() {
  _getDisplayMedia = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(constraints) {
    var displayMedia, needAttach, audioStream, screenWithAudio;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          needAttach = false; // this is a little gross because chrome doesn't support requesting audio but firefox does
          _context3.next = 3;
          return navigator.mediaDevices.getDisplayMedia();
        case 3:
          if (!_context3.sent) {
        ...
        case 16:
          ...
          screenWithAudio = new MediaStream();
          screenWithAudio.addTrack(screenStream.getVideoTracks()[0]);
          screenWithAudio.addTrack(audioStream.getAudioTracks()[0]);
          return _context3.abrupt("return", screenWithAudio);
        case 23:
          return _context3.abrupt("return", displayMedia);
        case 24:
        case "end":
...
LocalMedia.prototype.startScreenShare = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(constraints, cb) {
    var self, stream;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 4;
          return isScreenShareSourceAvailable();
        case 4:
          if (_context.sent) {
            _context.next = 7;
            break;
...
},{"hark":2,"lodash":3,"mockconsole":4,"wildemitter":5}],2:[function(require,module,exports){
...
},{"wildemitter":5}],3:[function(require,module,exports){
